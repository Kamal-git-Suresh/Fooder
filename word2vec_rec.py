...
import config
#from src import ingredient_parser 
...
def get_recs(ingredients, N=5, mean=False):
    ...
    model = Word2Vec.load(r'D:\Code\Whatscooking-\models\model_cbow.bin')
    model.init_sims(replace=True)
    if model:
        print("Successfully loaded model")
    # load in data
    data = pd.read_csv(r"D:\Code\Whatscooking-\input\df_parsed.csv")
    # parse ingredients
